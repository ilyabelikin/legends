...
/** Draw builder — person with a hammer */
function drawBuilder(
  ...
  // Arms with hammer
  ctx.fillStyle = PALETTE.skinTan;
  ctx.fillRect(x - 4, y - 7, 1, 3); // left arm
  ctx.fillRect(x + 3, y - 7, 1, 3); // right arm

  // Hammer (tool)
  ctx.fillStyle = "#a0a0a0"; // metal head
